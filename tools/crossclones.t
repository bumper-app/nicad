...
var minclonelines := 5			% minimum clone size (optional, default 3 lines)
...
const maxtotallines := 3000 * SIZE	% total lines in all potential clones together
...
const maxlinechars := 20000 * SIZE	% total characters in all unique lines
const maxlines := 400 * SIZE		% total unique lines
